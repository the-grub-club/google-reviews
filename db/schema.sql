...
6. Copy csv file in psql table: COPY reviews(reviewer, review_text, picture_url, date_posted, rating, restaurant_id) FROM '/Users/catherineokane/Documents/SDC/db/data.csv' DELIMITER ',' CSV HEADER;
